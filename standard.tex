...
Julia 1.5.3, and Nemo’s corresponding version of Flint. All the figures where
created using gnuplot version 5.2 pachlevel 8. The benchmark functions are
...
characteristic a prime number $p$ that grows from $3$ to $10^4$.
\begin{figure}
  \centering
  ...
  \alpha_{16})$ with $3\leq p\leq 10^4$.}
  \label{fig:degree-16}
\end{figure}
...
\[
  \mathbb{F}_{p^m}\emb\mathbb{F}_{p^{n}}
\]
seems to be the powering $(\alpha_n)^{\frac{n}{m}}$, which explains the fact
