...
\begin{lm}
  ...
  In this setting, there exists unique Kummer embedding
  \[
    \stdemb{m}{n}:A_m\emb A_n
  \]
...
\begin{proof}
  ...
  \]
  It follows from the diagram that $\hat\alpha$ is a solution
  of~\eqref{eq:h90-kummer} for $(\zeta_n)^{\frac{n}{m}}$ that also satisfies 
  \[
    \hat\alpha^m = 1\otimes\iota_{m,n}(\zeta_m).
  \]
...
of~\eqref{eq:h90-kummer} for $(\zeta_n)^\frac{n}{m}$.
%
