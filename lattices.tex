...
\begin{proof}
  ...
  Proposition~\ref{prop:number-embeddings-constructive}, with the embeddings
  $\embed{k_j}{K}$ and $\embed{k_j}{L}$.
  % TODO:
  % ====
  %
  % Explain (via a remark like in BCS97 maybe) the fact that we can work over
  % the base field instead of the subfield k_j.
\end{proof}
\begin{rem}
