...
the characteristic $q$ of $\K$ is large, the number of different formulas can be
...
\[
  \Phi(x, y) = \sum_{j=0}^t\ps{a_j}{x}\ps{a_j}{y}a_j,
\]
because each
...
imposes the choice of the vector $a_j\in V$. We thus propose \emph{ad hoc}
algorithms to find trisymmetric formulas, exploiting the vector space structure.
