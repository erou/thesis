...
$\phi^{-1}$.
% Nope, I don't think so! Easier to compute V_alpha to V_X and take the inverse,
% usually, I guess.
The map $V_\alpha\overset{\sim}{\to}V_\beta$ is represented by the identity
matrix, thus is straighforward to compute. The map
