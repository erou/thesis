...
$L$ and in order to emphasize which bases is used, we let
\[
  V_X
\]
...
\[
  V_\beta
\]
the subspace $V_\beta\subset L$ equipped with the basis $(1, \beta, \dots,
\beta^{n-1})$ that is isomorphic to $V_\alpha$.
