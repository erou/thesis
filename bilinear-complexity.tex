...
% ====
%
% Following Pieltant's PhD thesis:
% * how to interpret Chud**2 algorithm in terms of evaluation-interpolation
% * sufficient conditions to apply the theorem and consequences on the bilinear
% complexity
% * what it means for the function field and how we know some suitable function
% fields do exist
% * first generalization by Cenk and Özbudak
% * generalisation by Randriambololona
...
% TODO: explain the link between g and n
The challenge is
